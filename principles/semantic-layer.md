...
- **Zero-copy execution**: SPARQL is translated to source queries at runtime; no replication.
...
Example (non-normative): a Databricks warehouse is mapped with R2RML/OBDA and queried via SPARQL
through the semantic layer, which translates SPARQL to Databricks SQL on demand.
